...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            <div class="card">
                <header class="card-header p-3 rounded">
                    <a href="#" class="burger-btn d-block d-xl-none text-white">
                        <i class="bi bi-justify fs-3"></i>
                    </a>

                    <div class="header-profile float-end">
                        <div class="d-flex align-items-center">
                            <div class="profile-image me-2">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=ffffff&color=2b6cb0"
